...
public class Animation {
    ...
    public void setCurrentFrame(int currentFrame){////phương thức set frame, xem frame hiện tại là gì
    ...
    public void add(FrameImage frameImage, double timeToNextFrame){//phương thức add frame
    ...
    public void Update(long deltaTime){//phương thức update dựa vào thời gian thực( FPS )
    ...
    private void nextFrame(){//phương thức vẽ frame tiếp theo
    ...
    public boolean isLastFrame() {//frame cuối cùng kết thúc 1 hành động nào đó và trả lại hành động đứng yên ban đầu
        if (currentFrame == frameImages.size() - 1) {
            return true;
        } else {
            return false;
     ...
     public void flipAllImage(){//phương thức lật ngược hình lại khi quay khác direction
    ...
    public void draw(int x, int y, Graphics2D g2){//phương thức vẽ các animation    
